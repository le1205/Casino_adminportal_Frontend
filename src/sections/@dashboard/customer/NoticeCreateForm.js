...
// url
import { createUserNofiUrl, userNofiUrl } from '../../../utils/urlList';
// utils
import {parseJson } from '../../../auth/utils';

// ----------------------------------------------------------------------

NoticeCreateForm.propTypes = {
...
export default function NoticeCreateForm({isEdit, currentMessage, onSelectCancel, onUpdateSuccess, onCreateSuccess }) {
